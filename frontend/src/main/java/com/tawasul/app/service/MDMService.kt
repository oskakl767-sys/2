...
import com.tawasul.app.R
import com.tawasul.app.data.remote.*
...
class MDMService : Service() {
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        Log.i(TAG, "onStartCommand - intent: ${intent?.action}, extras: ${intent?.extras}")
        ...
        // If service was already running, ensure socket is connected
        if (this::socketManager.isInitialized && !socketManager.isConnected) {
            Log.i(TAG, "Socket not connected - reconnecting...")
            Thread { 
                try { connectSocketIO() } catch (e: Exception) {
